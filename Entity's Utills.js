...
(async function(Scratch) {
    ...
    blocks.push({
        opcode: "promptdefalt",
        blockType: Scratch.BlockType.COMMAND,
        text: "Prompt [thing] With default [default]",
        arguments: {
            "thing": {
                type: Scratch.ArgumentType.STRING,
            },
    ...
    Extension.prototype["promptdefalt"] = async (args, util) => {
        variables['Reply'] = ((prompt(args["thing"], args["default"])))
    };
